...
PROTO_TXT_PATH = r"/home/admin/SafeCross/deploy.prototxt"  # net prototxt file
MODEL_PATH = r"/home/admin/SafeCross/mobilenet_iter_73000.caffemodel"  # model weights
